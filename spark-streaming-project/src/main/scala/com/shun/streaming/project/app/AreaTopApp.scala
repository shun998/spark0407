package com.shun.streaming.project.app

import com.shun.streaming.project.bean.AdsInfo
import com.shun.streaming.project.util.RedisUtil
...
object AreaTopApp extends App {
    override def doSomething(adsInfoStream: DStream[AdsInfo]): Unit = {
        ...
        import com.shun.streaming.project.util.RealUtil._
        result.saveToRedis
    }
}
